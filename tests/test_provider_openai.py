...
from clawdhooks.providers.openai import OpenAIProvider, MODEL_ALIASES
...
def test_provider_name():
    with patch("clawdhooks.providers.openai.openai"):
...
async def test_complete_sends_correct_request():
    ...
    with patch("clawdhooks.providers.openai.openai") as mock_openai:
