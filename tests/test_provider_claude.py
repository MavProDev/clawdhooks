...
from clawdhooks.providers.claude import ClaudeProvider, MODEL_ALIASES
...
def test_provider_name():
    with patch("clawdhooks.providers.claude.anthropic"):
...
async def test_complete_sends_correct_request(mock_anthropic_client):
    with patch("clawdhooks.providers.claude.anthropic") as mock_anthropic:
...
async def test_complete_raises_on_no_tool_use(mock_anthropic_client):
    ...
    from clawdhooks.exceptions import HookProviderError
